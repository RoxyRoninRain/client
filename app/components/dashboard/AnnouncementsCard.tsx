            ...
            <div className="flex-1 overflow-y-auto space-y-4 pr-2">
                {announcements.length === 0 ? (
                    ...
                    announcements.map((item) => (
                        <div key={item.id} className="flex gap-3 items-start group hover:bg-gray-50 dark:hover:bg-gray-700/50 p-2 rounded-lg transition-colors">
                            ...
                            <div className="flex-1">
                                ...
                                {item.profiles && (
                                    <p className="text-xs text-gray-400 mt-1">
                                        Posted by <Link href={`/profile/${item.profiles.id}`} className="hover:text-teal-600 hover:underline">{item.profiles.real_name || item.profiles.kennel_name}</Link>
                                    </p>
                                )}
                            </div>
                        </div>
